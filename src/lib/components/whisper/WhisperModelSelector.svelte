...
<div class="mb-6 rounded-xl border-[3px] border-black bg-white p-6 shadow-neo-lg">
	...
	<div class="flex flex-col items-center gap-4">
		...
		{#if !isReady}
			<button
				onclick={onLoadModel}
				disabled={isLoading}
				class="font-space min-w-[180px] cursor-pointer rounded-lg border-[3px] border-black bg-neo-yellow px-7 py-3.5 text-base font-bold tracking-[0.5px] text-black uppercase shadow-neo-md transition-all duration-200 hover:enabled:-translate-x-0.5 hover:enabled:-translate-y-0.5 hover:enabled:shadow-neo-xl active:enabled:translate-x-0 active:enabled:shadow-neo-sm disabled:cursor-not-allowed disabled:bg-gray-200 disabled:text-gray-400"
			>
			...
			<div class="flex flex-col items-center gap-3">
				...
				{#if selectedModel !== availableModels[0].path}
					<button
						...
						disabled={isLoading}
						class="font-space cursor-pointer rounded-md border-2 border-black bg-gray-100 px-4 py-2 text-[0.875rem] font-semibold tracking-[0.5px] text-black uppercase transition-all duration-200 hover:bg-gray-200 hover:shadow-neo-sm disabled:cursor-not-allowed disabled:opacity-60"
					>
